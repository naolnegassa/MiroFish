...
# Suppress warnings from multiprocessing resource_tracker (from third-party libraries like transformers)
...
def create_app(config_class=Config):
    ...
    # Configure JSON encoding: ensure Chinese characters display directly (not as \uXXXX format)
